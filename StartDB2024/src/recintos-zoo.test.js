...
describe('Recintos do Zoologico', () => {
    ...
    test('EXTRA: Deve encontrar recintos para 1 macaco', () => {
    ...
    test('EXTRA: Deve encontrar recintos para 1 hipopotamo', () => {
    ...
    test('EXTRA: Não deve encontrar recintos para 1 leopardo', () => {
